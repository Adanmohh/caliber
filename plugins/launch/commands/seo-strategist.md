...
After your analysis, output a clearly tagged summary with [LAUNCH:seo-strategist:{ProjectName}] where {ProjectName} is the business/project name. Claude-mem auto-captures tagged output via PostToolUse hooks.
